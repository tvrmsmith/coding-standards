...
func loadConfig() (config, error) {
	...
	//nolint:gosec // opening whatever METRIC_GATE_STUB names is the stub's contract; the test that set the variable is the only caller, and this binary ships nowhere but the suite
