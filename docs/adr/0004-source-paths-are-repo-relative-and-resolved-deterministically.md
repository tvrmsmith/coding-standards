...
is a GUID in the document. The case's own comment carries the rest of the report shape. The hand-written `cobertura()` helper stays as it is, because a stale,
