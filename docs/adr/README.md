...
| [0008](0008-the-machine-document-is-the-only-output.md) | machine document | Stdout is one TOON document on every exit path. Every exit-1 cause carries a typed code, registered in `gate/internal/report`. |
